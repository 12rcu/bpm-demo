...
function test(data: any) {
  console.debug(`current rout: ${data}`)
  return true
}
</script>
...
<template>
  <div class="side-wrapper">
    ...
    <div class="side-menu">
      <router-link to="/">
        <a class="sidebar-link discover" v-bind:class="($route.fullPath == '/')?'is-active':''">
      ...
      <router-link to="/filtering">
        <a class="sidebar-link trending" v-bind:class="($route.fullPath == '/filtering')?'is-active':''">
          <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <router-link to="/user">
      <a class="sidebar-link" v-bind:class="($route.fullPath == '/user')?'is-active':''">
        <svg viewBox="0 0 24 24" fill="currentColor">
          <path
      ...
      <router-link to="/items">
        <a class="sidebar-link" v-bind:class="($route.fullPath == '/items')?'is-active':''">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path fill-rule="evenodd" clip-rule="evenodd"
      ...
      <router-link to="/authentication">
        <a class="sidebar-link" v-bind:class="($route.fullPath == '/authentication')?'is-active':''">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path fill-rule="evenodd" clip-rule="evenodd"
